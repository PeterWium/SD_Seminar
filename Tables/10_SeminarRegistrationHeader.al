table 123456710 "Seminar Registration Header"
{
    ...
    fields
    {
        ...
        field(11;"Room Resource Code";Code[10])
        {
            ...
            begin
                if "Room Resource Code" = '' then begin
                  ...
                  if (CurrFieldNo <> 0) then begin
                    if (SeminarRoom."CSD_Maximum Participents" <> 0) and
                       (SeminarRoom."CSD_Maximum Participents" < "Maximum Participants")
                    then begin
                      if Confirm(Text004,true,
                           "Maximum Participants",
                           SeminarRoom."CSD_Maximum Participents",
                           FieldCaption("Maximum Participants"),
                           "Maximum Participants",
                           SeminarRoom."CSD_Maximum Participents")
                      then
                        "Maximum Participants" := SeminarRoom."CSD_Maximum Participents";
                    end;
                  end;
                end;
            end;
